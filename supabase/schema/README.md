...
1. **Seed Data Integrity (`11_seed_reference.sql`)**: 
   ...
   - Fixes `[AuthProvider] check_student_app_access RPC failed: {}` errors on auth hydration
...
|----------|--------|---------|
| **Auth Hydration** | ✅ Fixed | System Tenant now created in seed data; `check_student_app_access()` RPC succeeds |
