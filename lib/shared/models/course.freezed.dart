...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hashAll([runtimeType,id,tenantId,title,description,status,thumbnailUrl,slug,teacherId,category,level,price,isFree,isFeatured,isDiscoverable,regionId,createdAt,updatedAt,totalLessons,rating,ratingCount,studentsCount,instructorName,instructorAvatar,const DeepCollectionEquality().hash(prerequisites),const DeepCollectionEquality().hash(learningObjectives),language,const DeepCollectionEquality().hash(sections),progressPct,completedLessons]);

@override
String toString() {
  return 'Course(id: $id, tenantId: $tenantId, title: $title, description: $description, status: $status, thumbnailUrl: $thumbnailUrl, slug: $slug, teacherId: $teacherId, category: $category, level: $level, price: $price, isFree: $isFree, isFeatured: $isFeatured, isDiscoverable: $isDiscoverable, regionId: $regionId, createdAt: $createdAt, updatedAt: $updatedAt, totalLessons: $totalLessons, rating: $rating, ratingCount: $ratingCount, studentsCount: $studentsCount, instructorName: $instructorName, instructorAvatar: $instructorAvatar, prerequisites: $prerequisites, learningObjectives: $learningObjectives, language: $language, sections: $sections, progressPct: $progressPct, completedLessons: $completedLessons)';
}
...
/// Create a copy of Course
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? id = null,Object? tenantId = null,Object? title = null,Object? description = freezed,Object? status = null,Object? thumbnailUrl = freezed,Object? slug = freezed,Object? teacherId = freezed,Object? category = freezed,Object? level = null,Object? price = null,Object? isFree = null,Object? isFeatured = null,Object? isDiscoverable = null,Object? regionId = freezed,Object? createdAt = freezed,Object? updatedAt = freezed,Object? totalLessons = freezed,Object? rating = freezed,Object? ratingCount = freezed,Object? studentsCount = freezed,Object? instructorName = freezed,Object? instructorAvatar = freezed,Object? prerequisites = freezed,Object? learningObjectives = freezed,Object? language = freezed,Object? sections = freezed,Object? progressPct = freezed,Object? completedLessons = freezed,}) {
...
as int?,studentsCount: freezed == studentsCount ? _self.studentsCount : studentsCount // ignore: cast_nullable_to_non_nullable
...
switch (_that) {
case _Course() when $default != null:
return $default(_that.id,_that.tenantId,_that.title,_that.description,_that.status,_that.thumbnailUrl,_that.slug,_that.teacherId,_that.category,_that.level,_that.price,_that.isFree,_that.isFeatured,_that.isDiscoverable,_that.regionId,_that.createdAt,_that.updatedAt,_that.totalLessons,_that.rating,_that.ratingCount,_that.studentsCount,_that.instructorName,_that.instructorAvatar,_that.prerequisites,_that.learningObjectives,_that.language,_that.sections,_that.progressPct,_that.completedLessons);case _:
  return orElse();
...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hashAll([runtimeType,id,tenantId,title,description,status,thumbnailUrl,slug,teacherId,category,level,price,isFree,isFeatured,isDiscoverable,regionId,createdAt,updatedAt,totalLessons,rating,ratingCount,studentsCount,instructorName,instructorAvatar,const DeepCollectionEquality().hash(_prerequisites),const DeepCollectionEquality().hash(_learningObjectives),language,const DeepCollectionEquality().hash(_sections),progressPct,completedLessons]);
