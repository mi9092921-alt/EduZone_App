...
class TodoRemoteDataSourceImpl implements TodoRemoteDataSource {
  ...
  Future<List<TodoItem>> fetchTodos(String userId) async {
    try {
      ...
      throw ServerException('Failed to fetch todos: $e'); // check-ignore
    }
  }
  ...
  Future<void> toggleTodoStatus(String todoId, bool isCompleted) async {
    try {
      ...
      throw ServerException('Failed to update todo status: $e'); // check-ignore
    }
  }
  ...
  Future<void> addTodo(TodoItem todo) async {
    try {
      ...
      throw ServerException('Failed to add todo: $e'); // check-ignore
    }
  }
  ...
  Future<void> updateTodo(TodoItem todo) async {
    try {
      ...
      throw ServerException('Failed to update todo: $e'); // check-ignore
    }
  }
  ...
  Future<void> deleteTodo(String todoId) async {
    try {
      ...
      throw ServerException('Failed to delete todo: ${e.message}'); // check-ignore
    } catch (e) {
      if (e is ServerException) rethrow;
      throw ServerException('Failed to delete todo: $e'); // check-ignore
    }
  }
}
