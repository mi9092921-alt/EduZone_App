...
mixin _$DownloadProgress {
 ...
 String get downloadId; String get lessonId; int get receivedBytes; int get totalBytes; double get progress; DownloadStatus get status; int? get downloadSpeed;// bytes per second
 int? get estimatedTimeRemaining;// seconds
...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,downloadId,lessonId,receivedBytes,totalBytes,progress,status,downloadSpeed,estimatedTimeRemaining,errorMessage);

@override
String toString() {
  return 'DownloadProgress(downloadId: $downloadId, lessonId: $lessonId, receivedBytes: $receivedBytes, totalBytes: $totalBytes, progress: $progress, status: $status, downloadSpeed: $downloadSpeed, estimatedTimeRemaining: $estimatedTimeRemaining, errorMessage: $errorMessage)';
}
...
@useResult
$Res call({
 String downloadId, String lessonId, int receivedBytes, int totalBytes, double progress, DownloadStatus status, int? downloadSpeed, int? estimatedTimeRemaining, String? errorMessage
});
...
/// Create a copy of DownloadProgress
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? downloadId = null,Object? lessonId = null,Object? receivedBytes = null,Object? totalBytes = null,Object? progress = null,Object? status = null,Object? downloadSpeed = freezed,Object? estimatedTimeRemaining = freezed,Object? errorMessage = freezed,}) {
...
as DownloadStatus,downloadSpeed: freezed == downloadSpeed ? _self.downloadSpeed : downloadSpeed // ignore: cast_nullable_to_non_nullable
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( String downloadId,  String lessonId,  int receivedBytes,  int totalBytes,  double progress,  DownloadStatus status,  int? downloadSpeed,  int? estimatedTimeRemaining,  String? errorMessage)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _DownloadProgress() when $default != null:
return $default(_that.downloadId,_that.lessonId,_that.receivedBytes,_that.totalBytes,_that.progress,_that.status,_that.downloadSpeed,_that.estimatedTimeRemaining,_that.errorMessage);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( String downloadId,  String lessonId,  int receivedBytes,  int totalBytes,  double progress,  DownloadStatus status,  int? downloadSpeed,  int? estimatedTimeRemaining,  String? errorMessage)  $default,) {final _that = this;
switch (_that) {
case _DownloadProgress():
return $default(_that.downloadId,_that.lessonId,_that.receivedBytes,_that.totalBytes,_that.progress,_that.status,_that.downloadSpeed,_that.estimatedTimeRemaining,_that.errorMessage);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( String downloadId,  String lessonId,  int receivedBytes,  int totalBytes,  double progress,  DownloadStatus status,  int? downloadSpeed,  int? estimatedTimeRemaining,  String? errorMessage)?  $default,) {final _that = this;
switch (_that) {
case _DownloadProgress() when $default != null:
return $default(_that.downloadId,_that.lessonId,_that.receivedBytes,_that.totalBytes,_that.progress,_that.status,_that.downloadSpeed,_that.estimatedTimeRemaining,_that.errorMessage);case _:
  return null;
...
class _DownloadProgress implements DownloadProgress {
  const _DownloadProgress({required this.downloadId, required this.lessonId, required this.receivedBytes, required this.totalBytes, this.progress = 0.0, required this.status, this.downloadSpeed, this.estimatedTimeRemaining, this.errorMessage});
...
/// Create a copy of DownloadProgress
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? downloadId = null,Object? lessonId = null,Object? receivedBytes = null,Object? totalBytes = null,Object? progress = null,Object? status = null,Object? downloadSpeed = freezed,Object? estimatedTimeRemaining = freezed,Object? errorMessage = freezed,}) {
